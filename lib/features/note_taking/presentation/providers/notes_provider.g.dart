...
final analyzeImageTextProvider = AutoDisposeProvider<AnalyzeImageText>.internal(
  analyzeImageText,
  name: r'analyzeImageTextProvider',
  debugGetCreateSourceHash: const bool.fromEnvironment('dart.vm.product')
      ? null
      : _$analyzeImageTextHash,
  dependencies: null,
  allTransitiveDependencies: null,
);
...
final summarizeNoteProvider = AutoDisposeProvider<SummarizeNote>.internal(
  summarizeNote,
  name: r'summarizeNoteProvider',
  debugGetCreateSourceHash: const bool.fromEnvironment('dart.vm.product')
      ? null
      : _$summarizeNoteHash,
  dependencies: null,
...
final updateNoteTitleProvider = AutoDisposeProvider<UpdateNoteTitle>.internal(
  updateNoteTitle,
  name: r'updateNoteTitleProvider',
  debugGetCreateSourceHash: const bool.fromEnvironment('dart.vm.product')
      ? null
      : _$updateNoteTitleHash,
  dependencies: null,
  allTransitiveDependencies: null,
);
...
final notebooksStreamProvider =
    AutoDisposeStreamProvider<List<NotebookEntity>>.internal(
  notebooksStream,
  name: r'notebooksStreamProvider',
  debugGetCreateSourceHash: const bool.fromEnvironment('dart.vm.product')
      ? null
      : _$notebooksStreamHash,
  dependencies: null,
  allTransitiveDependencies: null,
);
